...
//         circle.style.backgroundImage = "url(../assets/images/pointer.png)";
//         positionCircle(e);
//     });

//     input.addEventListener("pointerenter", function (e) {
//         //TweenMax.to(circle, 0.3, { scale: 0, opacity: 0 });
//         circle.style.backgroundImage = "url(../assets/images/text.png)";
//         positionCircle(e);
//     });

//     input.addEventListener("pointerleave", function (e) {
//         //TweenMax.to(circle, 0.3, { scale: 0, opacity: 0 });
//         circle.style.backgroundImage = "url(../assets/images/cursor.png)";
//         positionCircle(e);
//     });
